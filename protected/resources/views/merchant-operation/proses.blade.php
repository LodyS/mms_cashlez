...
<div class="card" >
    <div class="card-body">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="mersen-tab" data-toggle="tab" href="#mersen" role="tab" aria-controls="mersen" aria-selected="false">Merchant</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" id="foto-dokumen-tab" data-toggle="tab" href="#foto-dokumen" role="tab" aria-controls="foto-dokumen" aria-selected="false">Foto Dokumen</a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" id="lokasi-merchant-tab" data-toggle="tab" href="#lokasi-merchant" role="tab" aria-controls="lokasi-merchant" aria-selected="false">Foto Lokasi Merchant</a>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="mersen" role="tabpanel" aria-labelledby="mersen-tab">  
                ...
                @include('merchant-operation/proses-dokumen')
            </div>
            
            <div class="tab-pane fade" id="foto-dokumen" role="tabpanel" aria-labelledby="foto-dokumen-tab">  
