...
<div class="container">                      
    ...
    <?php $mo = App\Models\HistoriApproval::histori($data['fitur']->token_applicant, 27)?>
    <?php $return_sales = App\Models\HistoriApproval::return_sales($data['fitur']->token_applicant) ?>
        ...
        <div class="col">
            <div class="timeline-steps aos-init aos-animate" data-aos="fade-up">
                ...
                @if(isset($risk))
                    <div class="timeline-step">
                        <div>
                            <span class="circle"><span><i class="fa fa-exchange fa-5x" style="color:white" aria-hidden="true"></i></span></span>    
                        </div>
                ...
                @if(isset($approved))
                    <div class="timeline-step">
                        <div>
                            <span class="circle"><span><i class="fa fa-check-circle fa-5x" style="color:white"></i></span></span>    
                        </div>
